...
public class DomainsDirectory implements DomainContextInterface {
	...
	// these are public so you can refer to domains as literals outside this
	// class well
	// note that these string values aren't important -- it's the names of the
	// set methods that need to match the domains-directory.xml's
	...
	/**
	 * Clone constructor. Copy the map of registered domains.
	 * 
	 * @param dd
	 *            a <code>DomainsDirectory</code> value
	 */
	...
	/**
	 * Builds a <code>DomainsDirectory</code> instance from a
	 * <code>DomainContextInterface</code>.
	 * 
	 * @param object
	 *            a <code>DomainContextInterface</code> instance
	...
	/**
	 * Adds the specified domain to the directory. May be retrieved by using the
	 * specified name. If a domain is already registered for the specified name,
	 * the previous domain will be unregistered and returned.
	 * 
	 * @param name
	 *            The name of the domain.
	 * @param newDomain
	 *            The DomainInterface for the domain.
	...
	public DomainInterface getDomain(String name) {
		...
		if (domain != null) {
			// for some reason these need to be set here again, or they will
			// come up as null
