...
public class GenericDelegator implements Delegator {
	...
	/**
	 * A ThreadLocal variable to allow other methods to specify a session
	 * identifier (usually the visitId, though technically the Entity Engine
	...
	private static final AtomicReferenceFieldUpdater<GenericDelegator, LinkedBlockingDeque> testOperationsUpdater = AtomicReferenceFieldUpdater
			.newUpdater(GenericDelegator.class, LinkedBlockingDeque.class, "testOperations");
	...
	protected GenericDelegator(String delegatorFullName) throws GenericEntityException {
		// if (Debug.infoOn())
		// Debug.logInfo("Creating new Delegator with name \"" +
				...
				if (datasourceInfo.checkOnStart) {
					if (Debug.infoOn())
						Debug.logInfo("Doing database check as requested in entityengine.xml with addMissing="
								+ datasourceInfo.addMissingOnStart, module);
					try {
		...
		// in place just in case it is used in a service engine startup thing or
		// something

		// setup the crypto class; this also after the delegator is in the cache
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#getModelEntityMapByGroup(java.lang.String)
	 */
	...
	public GenericHelperInfo getGroupHelperInfo(String entityGroupName) {
		...
		if (UtilValidate.isNotEmpty(this.delegatorTenantId) && !"org.ofbiz.tenant".equals(entityGroupName)) {
			...
			try {
				...
				// cached query here and create a new object each time, will
				// avoid issues when the database data changes during run time
				// NOTE: always use the base delegator for this to avoid
				// problems when this is being initialized
				Delegator baseDelegator = DelegatorFactory.getDelegator(this.delegatorBaseName);
				GenericValue tenantDataSource = baseDelegator.findOne("TenantDataSource", true, "tenantId", this.delegatorTenantId,
				...
				if (tenantDataSource != null) {
					...
					// don't log this, happens too many times: if
					// (Debug.warningOn())
					// Debug.logWarning("Could not find TenantDataSource information for tenantId=["
					// + this.delegatorTenantId + "] and entityGroupName=[" +
					// entityGroupName + "] in delegator [" +
					// this.delegatorFullName +
					// "]; will be defaulting to settings for the base delegator name ["
					// + this.delegatorBaseName + "]", module);
				}
			} catch (GenericEntityException e) {
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#getEntityHelperName(org.ofbiz.entity.model
	 * .ModelEntity)
	 */
	...
	public GenericHelper getEntityHelper(String entityName) throws GenericEntityException {
		...
		if (helperInfo != null) {
			...
			throw new GenericEntityException("There is no datasource (Helper) configured for the entity-group ["
					+ this.getEntityGroupName(entityName) + "]; was trying to find datesource (helper) for entity [" + entityName + "]");
		}
	}
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#getEntityHelper(org.ofbiz.entity.model.ModelEntity
	 * )
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#getEntityFieldType(org.ofbiz.entity.model.
	 * ModelEntity, java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#getModelFieldTypeReader(org.ofbiz.entity.model
	 * .ModelEntity)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#getEntityFieldTypeNames(org.ofbiz.entity.model
	 * .ModelEntity)
	 */
	public Collection<String> getEntityFieldTypeNames(ModelEntity entity) throws GenericEntityException {
		...
		if (modelFieldTypeReader == null) {
			throw new GenericEntityException("ModelFieldTypeReader not found for entity " + entity.getEntityName() + " with helper name "
					+ helperName);
		}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#makeValueSingle(java.lang.String,
	 * java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#makeValidValue(java.lang.String,
	 * java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#makePKSingle(java.lang.String,
	 * java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#create(java.lang.String,
	 * java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#createSingle(java.lang.String,
	 * java.lang.Object)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#createSetNextSeqId(org.ofbiz.entity.GenericValue
	 * )
	 */
		...
		try {
			...
			try {
				...
				try {
					...
					// ignore this error, if not found it'll probably be a
					// GenericEntityNotFoundException
					// it is important to not let this get thrown because it
					// will mask the original exception
				}
			...
			String errMsg = "Failure in createSetNextSeqId operation for entity [" + value.getEntityName() + "]: " + e.toString()
	...
	public GenericValue create(GenericValue value, boolean doCacheClear) throws GenericEntityException {
		...
		try {
			...
			String errMsg = "Failure in create operation for entity [" + value.getEntityName() + "]: " + e.toString()
					+ ". Rolling back transaction.";
			Debug.logError(e, errMsg, module);
			try {
				// only rollback the transaction if we started one...
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#createOrStore(org.ofbiz.entity.GenericValue,
	 * boolean)
	 */
	public GenericValue createOrStore(GenericValue value, boolean doCacheClear) throws GenericEntityException {
		...
		try {
			...
			String errMsg = "Failure in createOrStore operation for entity [" + value.getEntityName() + "]: " + e.toString()
					+ ". Rolling back transaction.";
			Debug.logError(e, errMsg, module);
			try {
				// only rollback the transaction if we started one...
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#removeByPrimaryKey(org.ofbiz.entity.GenericPK)
	 */
	...
	public int removeByPrimaryKey(GenericPK primaryKey, boolean doCacheClear) throws GenericEntityException {
		...
		try {
			...
			// if audit log on for any fields, save old value before removing so
			// it's still there
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#removeValue(org.ofbiz.entity.GenericValue)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#removeByAnd(java.lang.String,
	 * java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#removeByAnd(java.lang.String, boolean,
	 * java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#removeByCondition(java.lang.String,
	 ...
	 * 
	 * @see org.ofbiz.entity.Delegator#removeByCondition(java.lang.String,
	 * org.ofbiz.entity.condition.EntityCondition, boolean)
	 */
	public int removeByCondition(String entityName, EntityCondition condition, boolean doCacheClear) throws GenericEntityException {
		...
		try {
			...
			String errMsg = "Failure in removeByCondition operation for entity [" + entityName + "]: " + e.toString()
					+ ". Rolling back transaction.";
			Debug.logError(e, errMsg, module);
			try {
				// only rollback the transaction if we started one...
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#removeRelated(java.lang.String,
	 ...
	 * 
	 * @see org.ofbiz.entity.Delegator#removeRelated(java.lang.String,
	 * org.ofbiz.entity.GenericValue, boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#refreshFromCache(org.ofbiz.entity.GenericValue
	 * )
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#storeByCondition(java.lang.String,
	 * java.util.Map, org.ofbiz.entity.condition.EntityCondition)
	 */
	 ...
	 * 
	 * @see org.ofbiz.entity.Delegator#storeByCondition(java.lang.String,
	 * java.util.Map, org.ofbiz.entity.condition.EntityCondition, boolean)
	 */
	public int storeByCondition(String entityName, Map<String, ? extends Object> fieldsToSet, EntityCondition condition,
		...
		try {
			...
			String errMsg = "Failure in storeByCondition operation for entity [" + entityName + "]: " + e.toString()
					+ ". Rolling back transaction.";
			Debug.logError(e, errMsg, module);
			try {
				// only rollback the transaction if we started one...
	...
	public int store(GenericValue value, boolean doCacheClear) throws GenericEntityException {
		...
		try {
			...
			String errMsg = "Failure in store operation for entity [" + value.getEntityName() + "]: " + e.toString()
					+ ". Rolling back transaction.";
			Debug.logError(e, errMsg, module);
			try {
				// only rollback the transaction if we started one...
			...
			for (GenericValue value : values) {
				...
				if (!primaryKey.isPrimaryKey()) {
					throw new GenericModelException(
							"[GenericDelegator.storeAll] One of the passed primary keys is not a valid primary key: " + primaryKey);
				}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#findOne(java.lang.String, boolean,
	 * java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#findOne(java.lang.String, java.util.Map,
	 * boolean)
	 */
	...
	public GenericValue findByPrimaryKeyPartial(GenericPK primaryKey, Set<String> keys) throws GenericEntityException {
		...
		try {
			...
			if (!primaryKey.isPrimaryKey()) {
				throw new GenericModelException("[GenericDelegator.findByPrimaryKey] Passed primary key is not a valid primary key: "
						+ primaryKey);
			}
	...
	@Deprecated
	public List<GenericValue> findByAnd(String entityName, String field1, Object value1, String field2, Object value2)
			throws GenericEntityException {
		return findByAnd(entityName, UtilMisc.<String, Object> toMap(field1, value1, field2, value2));
	}

	@Deprecated
	public List<GenericValue> findByAnd(String entityName, String field1, Object value1, String field2, Object value2, String field3,
			Object value3) throws GenericEntityException {
		return findByAnd(entityName, UtilMisc.<String, Object> toMap(field1, value1, field2, value2, field3, value3));
	}

	@Deprecated
	public List<GenericValue> findByAnd(String entityName, String field1, Object value1, String field2, Object value2, String field3,
			Object value3, String field4, Object value4) throws GenericEntityException {
		return findByAnd(entityName, UtilMisc.<String, Object> toMap(field1, value1, field2, value2, field3, value3, field4, value4));
	}

	@Deprecated
	public List<GenericValue> findByAnd(String entityName, String field1, Object value1, String field2, Object value2, String field3,
			Object value3, String field4, Object value4, String field5, Object value5) throws GenericEntityException {
		return findByAnd(entityName,
				UtilMisc.<String, Object> toMap(field1, value1, field2, value2, field3, value3, field4, value4, field5, value5));
	}
	 ...
	 * @return List of GenericValue instances that match the query
	 */
	public List<GenericValue> findByAnd(String entityName, Map<String, ? extends Object> fields, List<String> orderBy)
			throws GenericEntityException {
		EntityCondition ecl = EntityCondition.makeCondition(fields);
	 ...
	 * @return List of GenericValue instances that match the query
	 */
	public List<GenericValue> findByOr(String entityName, Map<String, ? extends Object> fields, List<String> orderBy)
			throws GenericEntityException {
		EntityCondition ecl = EntityCondition.makeCondition(fields, EntityOperator.OR);
		return this.findList(entityName, ecl, null, orderBy, null, false);
	}
	 ...
	 * @return List of GenericValue instances that match the query
	 */
	public List<GenericValue> findByAndCache(String entityName, Map<String, ? extends Object> fields, List<String> orderBy)
			throws GenericEntityException {
	 ...
	 * @return List of GenericValue instances that match the query
	 */
	public <T extends EntityCondition> List<GenericValue> findByAnd(String entityName, List<T> expressions, List<String> orderBy)
			throws GenericEntityException {
		EntityConditionList<T> ecl = EntityCondition.makeCondition(expressions, EntityOperator.AND);
		return this.findList(entityName, ecl, null, orderBy, null, false);
	}
	 ...
	 * @return List of GenericValue instances that match the query
	 */
	public <T extends EntityCondition> List<GenericValue> findByOr(String entityName, List<T> expressions, List<String> orderBy)
			throws GenericEntityException {
		EntityConditionList<T> ecl = EntityCondition.makeCondition(expressions, EntityOperator.OR);
		return this.findList(entityName, ecl, null, orderBy, null, false);
	}
	 ...
	 * NOTE 20080502: 1 references; all changed to findList
	 */
	public List<GenericValue> findByLike(String entityName, Map<String, ? extends Object> fields, List<String> orderBy)
			throws GenericEntityException {
		List<EntityExpr> likeExpressions = FastList.newInstance();
		if (fields != null) {
			for (Map.Entry<String, ? extends Object> fieldEntry : fields.entrySet()) {
	...
	public List<GenericValue> findByCondition(String entityName, EntityCondition whereEntityCondition,
		...
		try {
			...
			EntityListIterator eli = this.find(entityName, whereEntityCondition, havingEntityCondition, UtilMisc.toSet(fieldsToSelect),
					orderBy, findOptions);
			...
			String errMsg = "Failure in findByCondition operation for entity [" + entityName + "]: " + e.toString()
					+ ". Rolling back transaction.";
			Debug.logError(e, errMsg, module);
			try {
				// only rollback the transaction if we started one...
	 ...
	 * @return List of GenericValue objects representing the result
	 */
	public List<GenericValue> findByConditionCache(String entityName, EntityCondition entityCondition, Collection<String> fieldsToSelect,
			List<String> orderBy) throws GenericEntityException {
	...
	public EntityListIterator findListIteratorByCondition(String entityName, EntityCondition whereEntityCondition,
		...
		return this.find(entityName, whereEntityCondition, havingEntityCondition, UtilMisc.collectionToSet(fieldsToSelect), orderBy,
				findOptions);
	}
	...
	public EntityListIterator find(String entityName, EntityCondition whereEntityCondition, EntityCondition havingEntityCondition,
		...
		EntityListIterator eli = helper.findListIteratorByCondition(modelEntity, whereEntityCondition, havingEntityCondition,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#findList(java.lang.String,
	 * org.ofbiz.entity.condition.EntityCondition, java.util.Set,
	 * java.util.List, org.ofbiz.entity.util.EntityFindOptions, boolean)
	 */
	public List<GenericValue> findList(String entityName, EntityCondition entityCondition, Set<String> fieldsToSelect,
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#findListIteratorByCondition(org.ofbiz.entity
	 * .model.DynamicViewEntity, org.ofbiz.entity.condition.EntityCondition,
	 * org.ofbiz.entity.condition.EntityCondition, java.util.Collection,
	 * java.util.List, org.ofbiz.entity.util.EntityFindOptions)
	 */
	public EntityListIterator findListIteratorByCondition(DynamicViewEntity dynamicViewEntity, EntityCondition whereEntityCondition,
		...
		EntityListIterator eli = helper.findListIteratorByCondition(modelViewEntity, whereEntityCondition, havingEntityCondition,
				fieldsToSelect, orderBy, findOptions);
		eli.setDelegator(this);
	...
	public long findCountByAnd(String entityName, Object... fields) throws GenericEntityException {
		return findCountByCondition(entityName, EntityCondition.makeCondition(UtilMisc.<String, Object> toMap(fields), EntityOperator.AND),
				null, null);
	}
	 ...
	 */
	public long findCountByCondition(String entityName, EntityCondition whereEntityCondition, EntityCondition havingEntityCondition)
			throws GenericEntityException {
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#getMultiRelation(org.ofbiz.entity.GenericValue
	 ...
	 *         definition
	 */
	public List<GenericValue> getRelatedByAnd(String relationName, Map<String, ? extends Object> byAndFields, GenericValue value)
			throws GenericEntityException {
	 ...
	 *         definition
	 */
	public List<GenericValue> getRelatedOrderBy(String relationName, List<String> orderBy, GenericValue value)
			throws GenericEntityException {
	...
	public List<GenericValue> getRelated(String relationName, Map<String, ? extends Object> byAndFields, List<String> orderBy,
		...
		// they will be overridden by value's fields if over-specified this is
		// important for security and cleanliness
		Map<String, Object> fields = FastMap.newInstance();
		if (byAndFields != null)
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#getRelatedDummyPK(java.lang.String,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#getRelatedCache(java.lang.String,
	 * org.ofbiz.entity.GenericValue)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#getRelatedOne(java.lang.String,
	 * org.ofbiz.entity.GenericValue)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#getRelatedOneCache(java.lang.String,
	 * org.ofbiz.entity.GenericValue)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#clearCacheLineFlexible(org.ofbiz.entity.
	 * GenericEntity)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#clearCacheLineByCondition(java.lang.String,
	 * org.ofbiz.entity.condition.EntityCondition)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#clearCacheLine(org.ofbiz.entity.GenericPK)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#clearAllCacheLinesByDummyPK(java.util.Collection
	 * )
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#clearAllCacheLinesByValue(java.util.Collection
	 * )
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#getFromPrimaryKeyCache(org.ofbiz.entity.GenericPK
	 * )
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#putInPrimaryKeyCache(org.ofbiz.entity.GenericPK
	 * , org.ofbiz.entity.GenericValue)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#setDistributedCacheClear(org.ofbiz.entity.
	 * util.DistributedCacheClear)
	 */
	...
	protected static <T> EntityEcaRuleRunner<T> createEntityEcaRuleRunner(EntityEcaHandler<T> entityEcaHandler, String entityName) {
		return new EntityEcaRuleRunner<T>(entityEcaHandler, entityEcaHandler != null ? entityEcaHandler.getEntityEventMap(entityName)
				: null);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.entity.Delegator#setEntityEcaHandler(org.ofbiz.entity.eca.
	 * EntityEcaHandler)
	 */
	...
	public String getNextSeqId(String seqName, long staggerMax) {
		...
		if (nextSeqLong == null) {
			...
			// exception when no sequence value is found, which means we should
			// never see it get here
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#setNextSubSeqId(org.ofbiz.entity.GenericValue,
	...
	public void setNextSubSeqId(GenericValue value, String seqFieldName, int numericPadding, int incrementBy) {
		if (value != null && UtilValidate.isEmpty(value.getString(seqFieldName))) {
			...
			try {
				...
				// ", and the seqFieldName: " + seqFieldName +
				// ", and the results are: " + allValues, module);
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#encryptFields(org.ofbiz.entity.GenericEntity)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#decryptFields(org.ofbiz.entity.GenericEntity)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.entity.Delegator#setEntityCrypto(org.ofbiz.entity.util.EntityCrypto
	 * )
	 */
