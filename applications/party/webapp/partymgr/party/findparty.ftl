  ...
  <div class="span2 main-menu-span">
	<div class="well sidebar-nav">
		<ul class="nav nav-tabs nav-stacked main-menu">
			...
			<!--li><a href="<@ofbizUrl>${createUrl}</@ofbizUrl>">${uiLabelMap.CommonCreateNew}</a></li-->
...
<#else>
  <#assign hideFields = "N">
	...
	<div>
		<ul class="breadcrumb">
			<li>
				${uiLabelMap.PartyFindParties}
			</li>
		</ul>
	</div>

<#if myCompanyName?exists>
 <div align="" style=" margin-right: 10px; margin-top: 10px;">
      <div class="insideHeaderSubtext" id="ext-gen12">
        <b id="ext-gen13">${uiLabelMap.currentParty}</b>:&nbsp;&nbsp; <a href="/partymgr/control/viewprofile?partyId=${myCompanyId}" style="" class="linktext" target="" id="ext-gen35">${myCompanyName}</a>
      </div>
  </div> 
</#if>
    ...
    <div id="findPartyParameters" <#if hideFields != "N"> style="display:none" </#if> >
      ...
      <form method="post" name="lookupparty" action="<@ofbizUrl>findparty</@ofbizUrl>" class="basic-form">
        ...
        <table class="basic-table" cellspacing="0">
          ...
          <tr>
            <td class="label">${uiLabelMap.partyRelationshipTypeId}</td>
            <td><input type="text" name="partyRelationshipTypeId" value="EMPLOYMENT"/></td> 
          </tr>
          <tr>
