...
<table class="fourColumnForm" style="border-collapse: initial;">
  ...
  <#if isCreate>
  <tr>
  <td class="label"><span class="tableheadtext">&nbsp;</span></td>
  <td colspan="4" class="formSectionHeader">
  		<span class="formSectionHeaderTitle">${uiLabelMap.PartyContactInformation}</span>
  </td>
  ...
  <td class="label"><span class="tableheadtext">&nbsp;</span></td>
  <td colspan="4" class="formSectionHeader">
  	<span class="formSectionHeaderTitle">${uiLabelMap.CrmPrimaryAddress}</span>
  </td></tr>
  <tr>
