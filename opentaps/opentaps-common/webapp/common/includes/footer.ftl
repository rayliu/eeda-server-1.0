...
<div id="footer">
    <div class="tabletext">${uiLabelMap.OpentapsProductName}</div>
</div>
<!-- external javascript
	================================================== -->
	...
	<script src="/eeda/js/excanvas.js"></script>
	<script src="/eeda/js/jquery.flot.min.js"></script>
	<script src="/eeda/js/jquery.flot.pie.min.js"></script>
	<script src="/eeda/js/jquery.flot.stack.js"></script>
	<script src="/eeda/js/jquery.flot.resize.min.js"></script>
	<!-- chart libraries end -->

	<!-- select or dropdown enhancer -->
	<script src="/eeda/js/jquery.chosen.min.js"></script>
	<!-- checkbox, radio, and file input styler -->
	<script src="/eeda/js/jquery.uniform.min.js"></script>
	<!-- plugin for gallery image view -->
	<script src="/eeda/js/jquery.colorbox.min.js"></script>
	<!-- rich text editor library -->
	<script src="/eeda/js/jquery.cleditor.min.js"></script>
	<!-- notification plugin -->
	<script src="/eeda/js/jquery.noty.js"></script>
	<!-- file manager library -->
	<script src="/eeda/js/jquery.elfinder.min.js"></script>
	<!-- star rating plugin -->
	<script src="/eeda/js/jquery.raty.min.js"></script>
	<!-- for iOS style toggle switch -->
	<script src="/eeda/js/jquery.iphone.toggle.js"></script>
	<!-- autogrowing textarea plugin -->
	<script src="/eeda/js/jquery.autogrow-textarea.js"></script>
	<!-- multiple file upload plugin -->
	<script src="/eeda/js/jquery.uploadify-3.1.min.js"></script>
	<!-- history.js for cross-browser state change on ajax -->
	<script src="/eeda/js/jquery.history.js"></script>
	<!-- application script for Charisma demo -->
	<script src="/eeda/js/charisma.js"></script>
