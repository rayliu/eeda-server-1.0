...
<div class="subSectionBlock ">
  <form method="post" action="<@ofbizUrl>${parameters._CURRENT_VIEW_}</@ofbizUrl>" name="findForm">
    ...
    <@flexArea targetId="searchByName" 
    	save=false state=searchByName?default(false)?string("open", "closed") 
    	enabled=false controlClassClosed="hidden" 
    	controlClassOpen="hidden" style="border:0px">
      <table class="twoColumnForm">
        <tr>
          <td class="titleCell"><span class="tableheadtext">${uiLabelMap.OpentapsFindBy}-test</span></td>
          <td>
