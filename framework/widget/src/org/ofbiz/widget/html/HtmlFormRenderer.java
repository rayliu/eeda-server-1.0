...
public class HtmlFormRenderer extends HtmlWidgetRenderer implements
	...
	public void appendOfbizUrl(Appendable writer, String location)
			throws IOException {
		writer.append(this.rh.makeLink(this.request, this.response, location));
	}

	public void appendContentUrl(Appendable writer, String location)
			throws IOException {
		ContentUrlTag.appendContentPrefix(this.request, writer);
		writer.append(location);
	}

	public void appendTooltip(Appendable writer, Map<String, Object> context,
	...
	public void addAsterisks(Appendable writer, Map<String, Object> context,
			ModelFormField modelFormField) throws IOException {
	...
	public void appendClassNames(Appendable writer,
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderDisplayField(java.io.Writer
	 * , java.util.Map, org.ofbiz.widget.form.ModelFormField.DisplayField)
	 */
	public void renderDisplayField(Appendable writer,
		...
		if (UtilValidate.isEmpty(description)) {
			this.renderFormatEmptySpace(writer, context,
		...
		ModelFormField.InPlaceEditor inPlaceEditor = displayField
				.getInPlaceEditor();
		...
		if (ajaxEnabled) {
			...
			if (fieldMap != null) {
				...
				for (Entry<String, Object> field : fieldMap.entrySet()) {
					count++;
					url.append(field.getKey()).append('=')
			...
			if (UtilValidate.isNotEmpty(inPlaceEditor.getParamName())) {
				writer.append("paramName: '")
						.append(inPlaceEditor.getParamName()).append("'");
			} else {
				writer.append("paramName: '")
						.append(modelFormField.getFieldName()).append("'");
			}
			...
			if (UtilValidate.isNotEmpty(inPlaceEditor.getCancelText())) {
				writer.append(", cancelText: '")
						.append(inPlaceEditor.getCancelText()).append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getClickToEditText())) {
				writer.append(", clickToEditText: '")
						.append(inPlaceEditor.getClickToEditText()).append("'");
			}
			...
			if (UtilValidate.isNotEmpty(inPlaceEditor.getFormClassName())) {
				writer.append(", formClassName: '")
						.append(inPlaceEditor.getFormClassName()).append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getHighlightColor())) {
				writer.append(", highlightColor: '")
						.append(inPlaceEditor.getHighlightColor()).append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getHighlightEndColor())) {
				writer.append(", highlightEndColor: '")
						.append(inPlaceEditor.getHighlightEndColor())
						.append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getHoverClassName())) {
				writer.append(", hoverClassName: '")
						.append(inPlaceEditor.getHoverClassName()).append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getHtmlResponse())) {
				writer.append(", htmlResponse: ").append(
						inPlaceEditor.getHtmlResponse());
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getLoadingClassName())) {
				writer.append(", loadingClassName: '")
						.append(inPlaceEditor.getLoadingClassName())
						.append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getLoadingText())) {
				writer.append(", loadingText: '")
						.append(inPlaceEditor.getLoadingText()).append("'");
			}
			...
			if (UtilValidate.isNotEmpty(inPlaceEditor.getOkText())) {
				writer.append(", okText: '").append(inPlaceEditor.getOkText())
						.append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getSavingClassName())) {
				writer.append(", savingClassName: '")
						.append(inPlaceEditor.getSavingClassName())
						.append("', ");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getSavingText())) {
				writer.append(", savingText: '")
						.append(inPlaceEditor.getSavingText()).append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getSubmitOnBlur())) {
				writer.append(", submitOnBlur: ").append(
						inPlaceEditor.getSubmitOnBlur());
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getTextBeforeControls())) {
				writer.append(", textBeforeControls: '")
						.append(inPlaceEditor.getTextBeforeControls())
						.append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getTextAfterControls())) {
				writer.append(", textAfterControls: '")
						.append(inPlaceEditor.getTextAfterControls())
						.append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getTextBetweenControls())) {
				writer.append(", textBetweenControls: '")
						.append(inPlaceEditor.getTextBetweenControls())
						.append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor
					.getUpdateAfterRequestCall())) {
				writer.append(", updateAfterRequestCall: ").append(
						inPlaceEditor.getUpdateAfterRequestCall());
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getRows())) {
				writer.append(", rows: '").append(inPlaceEditor.getRows())
						.append("'");
			}
			if (UtilValidate.isNotEmpty(inPlaceEditor.getCols())) {
				writer.append(", cols: '").append(inPlaceEditor.getCols())
						.append("'");
			}
			writer.append("});");
		...
		if (displayField instanceof DisplayEntityField) {
			this.makeHyperlinkString(writer,
					((DisplayEntityField) displayField).getSubHyperlink(),
					context);
		}
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderHyperlinkField(java.io
	 * .Writer, java.util.Map,
	 * org.ofbiz.widget.form.ModelFormField.HyperlinkField)
	 */
	public void renderHyperlinkField(Appendable writer,
		...
		WidgetWorker.makeHyperlinkByType(writer, hyperlinkField.getLinkType(),
				...
				hyperlinkField.getTargetWindow(context), confirmation,
	...
	public void makeHyperlinkString(Appendable writer,
		...
		if (subHyperlink.shouldUse(context)) {
			...
			WidgetWorker.makeHyperlinkByType(writer,
					...
					subHyperlink.getModelFormField(), this.request,
	...
	public void renderTextField(Appendable writer, Map<String, Object> context,
		...
		List<ModelForm.UpdateArea> updateAreas = modelFormField
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderTextareaField(java.io.
	 * Writer, java.util.Map,
	 * org.ofbiz.widget.form.ModelFormField.TextareaField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderDateTimeField(java.io.
	 * Writer, java.util.Map,
	 * org.ofbiz.widget.form.ModelFormField.DateTimeField)
	 */
	public void renderDateTimeField(Appendable writer,
		...
		String defaultDateTimeString = dateTimeField
				.getDefaultDateTimeString(context);
		...
		boolean shortDateInput = ("date".equals(dateTimeField.getType())
				|| "time-dropdown".equals(dateTimeField.getInputMethod()) ? true
				: false);
		boolean shortTimeInput = "time".equals(dateTimeField.getType()) ? true
				: false;
		...
		if (shortDateInput) {
			size = maxlength = 10;
			if (uiLabelMap != null) {
				localizedInputTitle = UtilProperties.getMessage(
						"CommonUiLabels", "CommonFormatLocalizedDateTime",
						UtilMisc.toMap("localizedFormat", dateFormat), locale);
			}
			...
			if (uiLabelMap != null) {
				localizedInputTitle = UtilProperties.getMessage(
						"CommonUiLabels", "CommonFormatLocalizedDateTime",
						UtilMisc.toMap("localizedFormat", timeFormat), locale);
			}
		} else {
			if (uiLabelMap != null) {
				localizedInputTitle = UtilProperties.getMessage(
						"CommonUiLabels", "CommonFormatLocalizedDateTime",
						UtilMisc.toMap("localizedFormat", dateTimeFormat),
						locale);
			}
		}
		writer.append(" title=\"");
		...
		if (UtilValidate.isNotEmpty(value)) {
			...
			writer.append(" value=\"");
			writer.append(shortDateInput ? valueParts[0]
					: shortTimeInput ? valueParts[1] : value);
			writer.append('"');
		}
		...
		// add calendar pop-up button and seed data IF this is not a "time" type
		// date-time
		if (!"time".equals(dateTimeField.getType())) {
			...
			writer.append("    if (calendar.dateClicked) {//test in java  \n");
			...
			// err comes here 2013-08-12 liuyubie@gmail.com
			writer.append("  Calendar.setup({\n");
			writer.append("    inputField: \"");
			writer.append(idName);
			writer.append("\",\n");
			writer.append("    ifFormat: \"");
			writer.append(shortDateInput ? UtilDateTime
					.getJsDateTimeFormat(dateFormat) : UtilDateTime
					.getJsDateTimeFormat(dateTimeFormat));
			writer.append("\",\n");
		...
		if ("time-dropdown".equals(dateTimeField.getInputMethod())) {
			...
			Calendar cal = null;
			try {
				Timestamp defaultTimestamp = UtilDateTime
						.stringToTimeStamp(modelFormField.getEntry(context,
								defaultDateTimeString), dateTimeFormat,
								timeZone, locale);
			...
			writer.append("&nbsp;<select name=\"")
					.append(UtilHttp.makeCompositeParam(paramName, "hour"))
					.append("\"");
			writer.append(classString).append(">");

			// keep the two cases separate because it's hard to understand a
			// combined loop
			if (isTwelveHour) {
				for (int i = 1; i <= 12; i++) {
			...
			writer.append(classString).append(">");
			for (int i = 0; i < 60; i++) {
				writer.append("<option value=\"").append(Integer.toString(i))
						.append("\"");
			...
			if (isTwelveHour) {
				...
				String pmSelected = ((cal != null && cal.get(Calendar.AM_PM) == Calendar.PM) ? "selected"
						: "");
				writer.append("<select name=\"")
						.append(UtilHttp.makeCompositeParam(paramName, "ampm"))
						.append("\"");
				writer.append(classString).append(">");
				writer.append("<option value=\"AM\" ").append(amSelected)
						.append(">AM</option>");
				writer.append("<option value=\"PM\" ").append(pmSelected)
						.append(">PM</option>");
				writer.append("</select>");
			}

			// create a hidden field for the composite type, which is a
			// Timestamp
			writer.append("<input type=\"hidden\" name=\"");
			writer.append(UtilHttp.makeCompositeParam(paramName,
					"compositeType"));
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderDropDownField(java.io.
	 * Writer, java.util.Map,
	...
	public void renderDropDownField(Appendable writer,
		...
		ModelFormField.AutoComplete autoComplete = dropDownField
				.getAutoComplete();
		boolean ajaxEnabled = autoComplete != null && this.javaScriptEnabled;
		List<ModelFormField.OptionValue> allOptionValues = dropDownField
				.getAllOptionValues(context, modelForm.getDelegator(context));
		...
		if (UtilValidate.isNotEmpty(currentValue)) {
			for (ModelFormField.OptionValue optionValue : allOptionValues) {
				if (encode(optionValue.getKey(), modelFormField, context)
						.equals(currentValue)) {
		...
		if (ajaxEnabled) {
			...
			if (UtilValidate.isNotEmpty(currentValue)) {
				...
				if (currentDescription != null) {
					...
					explicitDescription = dropDownField
							.getCurrentDescription(context);
				}
				if (UtilValidate.isEmpty(explicitDescription)) {
					explicitDescription = ModelFormField.FieldInfoWithOptions
							.getDescriptionForOptionKey(currentValue,
									allOptionValues);
				}
			...
			for (ModelFormField.OptionValue optionValue : allOptionValues) {
				...
				writer.append(" '").append(optionValue.getDescription())
						.append("'");
			...
			writer.append("};");
			appendWhitespace(writer);
			writer.append("ajaxAutoCompleteDropDown('").append(textFieldIdName)
					.append("', '").append(idName)
					.append("', data, {autoSelect: ")
					.append(autoComplete.getAutoSelect())
					.append(", frequency: ")
					.append(autoComplete.getFrequency()).append(", minChars: ")
					.append(autoComplete.getMinChars()).append(", choices: ")
					.append(autoComplete.getChoices())
					.append(", partialSearch: ")
					.append(autoComplete.getPartialSearch())
					.append(", partialChars: ")
					.append(autoComplete.getPartialChars())
					.append(", ignoreCase: ")
					.append(autoComplete.getIgnoreCase())
					.append(", fullSearch: ")
					.append(autoComplete.getFullSearch()).append("});");
			appendWhitespace(writer);
			writer.append("</script>");
		} else {
			writer.append('"');
			...
			String otherFieldName = dropDownField
					.getParameterNameOther(context);
			if (otherFieldSize > 0) {
			...
			writer.append(" size=\"").append(dropDownField.getSize())
					.append("\">");
			...
			if (UtilValidate.isNotEmpty(currentValue)
				...
				writer.append(currentValue);
				writer.append("\">");
				String explicitDescription = (currentDescription != null ? currentDescription
						: dropDownField.getCurrentDescription(context));
				if (UtilValidate.isNotEmpty(explicitDescription)) {
					writer.append(encode(explicitDescription, modelFormField,
							context));
				} else {
					String description = ModelFormField.FieldInfoWithOptions
							.getDescriptionForOptionKey(currentValue,
									allOptionValues);
			...
			for (ModelFormField.OptionValue optionValue : allOptionValues) {
				String noCurrentSelectedKey = dropDownField
						.getNoCurrentSelectedKey(context);
				writer.append("<option");
				// if current value should be selected in the list, select it
				if (UtilValidate.isNotEmpty(currentValue)
						&& currentValue.equals(encode(optionValue.getKey(),
								modelFormField, context))
			...
			if (otherFieldSize > 0) {
				...
				Map<String, Object> dataMap = UtilGenerics
						.checkMap(modelFormField.getMap(context));
				if (dataMap == null) {
					dataMap = context;
				}
				Object otherValueObj = dataMap.get(otherFieldName);
				String otherValue = (otherValueObj == null) ? ""
		...
		this.makeHyperlinkString(writer, dropDownField.getSubHyperlink(),
				context);
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderCheckField(java.io.Writer,
	 * java.util.Map, org.ofbiz.widget.form.ModelFormField.CheckField)
	 */
	public void renderCheckField(Appendable writer,
		...
		List<ModelFormField.OptionValue> allOptionValues = checkField
				.getAllOptionValues(context, modelForm.getDelegator(context));
		String event = modelFormField.getEvent();
		String action = modelFormField.getAction(context);
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderRadioField(java.io.Writer,
	 * java.util.Map, org.ofbiz.widget.form.ModelFormField.RadioField)
	 */
	public void renderRadioField(Appendable writer,
		...
		ModelForm modelForm = modelFormField.getModelForm();
		List<ModelFormField.OptionValue> allOptionValues = radioField
				.getAllOptionValues(context, modelForm.getDelegator(context));
		String currentValue = modelFormField.getEntry(context);
		String event = modelFormField.getEvent();
		String action = modelFormField.getAction(context);
		...
		for (ModelFormField.OptionValue optionValue : allOptionValues) {
			...
			// if current value should be selected in the list, select it
			String noCurrentSelectedKey = radioField
					.getNoCurrentSelectedKey(context);
			if (UtilValidate.isNotEmpty(currentValue)
					&& currentValue.equals(encode(optionValue.getKey(),
							modelFormField, context))) {
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderSubmitField(java.io.Writer
	 * , java.util.Map, org.ofbiz.widget.form.ModelFormField.SubmitField)
	 */
	public void renderSubmitField(Appendable writer,
		...
		if ("text-link".equals(submitField.getButtonType())) {
			...
			List<ModelForm.UpdateArea> updateAreas = modelForm
					.getOnSubmitUpdateAreas();
			// This is here for backwards compatibility. Use
			// on-event-update-area
			// elements instead.
			String backgroundSubmitRefreshTarget = submitField
					.getBackgroundSubmitRefreshTarget(context);
			...
			boolean ajaxEnabled = (updateAreas != null || UtilValidate
					.isNotEmpty(backgroundSubmitRefreshTarget))
			...
			if (UtilValidate.isNotEmpty(event)
				...
				// disabling for now, using form onSubmit action instead:
				// writer.append(singleClickAction);
			}
			...
			if (ajaxEnabled) {
				...
				writer.append("', '").append(
						createAjaxParamsFromUpdateAreas(updateAreas, null,
								context));
				writer.append("')\"");
			}
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderResetField(java.io.Writer,
	 * java.util.Map, org.ofbiz.widget.form.ModelFormField.ResetField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderHiddenField(java.io.Writer
	 * , java.util.Map, org.ofbiz.widget.form.ModelFormField.HiddenField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderIgnoredField(java.io.Writer
	 * , java.util.Map, org.ofbiz.widget.form.ModelFormField.IgnoredField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFieldTitle(java.io.Writer,
	...
	public void renderFieldTitle(Appendable writer,
		...
		if (UtilValidate.isNotEmpty(titleText)) {
			...
			if (" ".equals(titleText)) {
				// If the title content is just a blank then render it colling
	...
	public void renderSingleFormFieldTitle(Appendable writer,
		...
		if (requiredField) {
			...
			renderHyperlinkTitle(writer, context, modelFormField,
					modelFormField.getTitle(context));
			if (UtilValidate.isNotEmpty(requiredStyle)) {
				writer.append("</span>");
			}
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormOpen(java.io.Writer,
	...
	public void renderFormOpen(Appendable writer, Map<String, Object> context,
		...
		renderBeginningBoundaryComment(writer, "Form Widget - Form Element",
				modelForm);
		...
		if (UtilValidate.isNotEmpty(targ)) {
			...
			WidgetWorker.buildHyperlinkUrl(writer, targ, targetType, null,
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormClose(java.io.Writer,
	 * java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	public void renderFormClose(Appendable writer, Map<String, Object> context,
		...
		appendWhitespace(writer);
		renderEndingBoundaryComment(writer, "Form Widget - Form Element",
				modelForm);
	}
	...
	public void renderMultiFormClose(Appendable writer,
		...
		for (ModelFormField submitField : modelForm.getMultiSubmitFields()) {
			if (submitField != null) {
				...
				// Threw this in that as a hack to keep the submit button from
				// expanding the first field
				// Needs a more rugged solution
				// WARNING: this method (renderMultiFormClose) must be called
				// after the
				// table that contains the list has been closed (to avoid
				// validation errors) so
				// we cannot call here the methods renderFormatItemRowCell*: for
				// this reason
				// they are now commented.

				// this.renderFormatItemRowCellOpen(writer, context, modelForm,
				// submitField);
				// this.renderFormatItemRowCellClose(writer, context, modelForm,
				// submitField);
		...
		// see if there is anything that needs to be added outside of the
		// multi-form
		Map<String, Object> wholeFormContext = UtilGenerics.checkMap(context
				.get("wholeFormContext"));
		Appendable postMultiFormWriter = wholeFormContext != null ? (Appendable) wholeFormContext
				.get("postMultiFormWriter") : null;
		...
		renderEndingBoundaryComment(writer,
				"Form Widget - Form Element (Multi)", modelForm);
	}
	...
	public void renderFormatListWrapperOpen(Appendable writer,
		...
		Map<String, Object> inputFields = UtilGenerics.checkMap(context
				.get("requestParameters"));
		Map<String, Object> queryStringMap = UtilGenerics.toMap(context
				.get("queryStringMap"));
	...
	public void renderFormatListWrapperClose(Appendable writer,
		...
		renderEndingBoundaryComment(writer,
				"Form Widget - Formal List Wrapper", modelForm);
	}
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatHeaderRowOpen(java
	 * .io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatHeaderRowClose(java
	 * .io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	 ...
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm,
	 * org.ofbiz.widget.form.ModelFormField, int positionSpan)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatHeaderRowCellClose
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm,
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatHeaderRowFormCellClose
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ofbiz.widget.form.FormStringRenderer#
	 * renderFormatHeaderRowFormCellTitleSeparator(java.io.Writer,
	 * java.util.Map, org.ofbiz.widget.form.ModelForm, boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatItemRowOpen(java
	 * .io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatItemRowClose(java
	 * .io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatItemRowCellOpen(
	 * java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm,
	 * org.ofbiz.widget.form.ModelFormField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatItemRowCellClose
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm,
	 * org.ofbiz.widget.form.ModelFormField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatItemRowFormCellOpen
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatItemRowFormCellClose
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	...
	public void renderFormatSingleWrapperOpen(Appendable writer,
		...
		if (UtilValidate.isNotEmpty(modelForm.getDefaultTableStyle())) {
			writer.append(" class=\"").append(modelForm.getDefaultTableStyle())
					.append("\"");
		}
		writer.append(">");
		appendWhitespace(writer);
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatFieldRowOpen(java
	 * .io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatFieldRowClose(java
	 * .io.Writer, java.util.Map, org.ofbiz.widget.form.ModelForm)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatFieldRowTitleCellOpen
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelFormField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatFieldRowTitleCellClose
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelFormField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatFieldRowSpacerCell
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelFormField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatFieldRowWidgetCellOpen
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelFormField,
	 * int)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFormatFieldRowWidgetCellClose
	 * (java.io.Writer, java.util.Map, org.ofbiz.widget.form.ModelFormField,
	 * int)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderTextFindField(java.io.
	 * Writer, java.util.Map,
	 * org.ofbiz.widget.form.ModelFormField.TextFindField)
	 */
	public void renderTextFindField(Appendable writer,
			Map<String, Object> context, TextFindField textFindField)
			throws IOException {
		...
		if (!textFindField.getHideOptions()) {
			String opEquals = UtilProperties.getMessage("conditional",
					"equals", locale);
			String opBeginsWith = UtilProperties.getMessage("conditional",
					"begins_with", locale);
			String opContains = UtilProperties.getMessage("conditional",
					"contains", locale);
			String opIsEmpty = UtilProperties.getMessage("conditional",
					"is_empty", locale);
			String opNotEqual = UtilProperties.getMessage("conditional",
					"not_equal", locale);
			writer.append(" <select name=\"");
			writer.append(modelFormField.getParameterName(context));
			writer.append("_op\" class=\"selectBox\">");
			writer.append("<option value=\"equals\"")
					.append(("equals".equals(defaultOption) ? " selected" : ""))
					.append(">").append(opEquals).append("</option>");
			writer.append("<option value=\"like\"")
					.append(("like".equals(defaultOption) ? " selected" : ""))
					.append(">").append(opBeginsWith).append("</option>");
			writer.append("<option value=\"contains\"")
					.append(("contains".equals(defaultOption) ? " selected"
							: "")).append(">").append(opContains)
					.append("</option>");
			writer.append("<option value=\"empty\"")
					.append(("empty".equals(defaultOption) ? " selected" : ""))
					.append(">").append(opIsEmpty).append("</option>");
			writer.append("<option value=\"notEqual\"")
					.append(("notEqual".equals(defaultOption) ? " selected"
							: "")).append(">").append(opNotEqual)
					.append("</option>");
			writer.append("</select>");
		} else {
			writer.append(" <input type=\"hidden\" name=\"");
			writer.append(modelFormField.getParameterName(context));
			writer.append("_op\" value=\"").append(defaultOption)
					.append("\"/>");
		}
		...
		if (!textFindField.getHideIgnoreCase()) {
			...
			writer.append(modelFormField.getParameterName(context));
			writer.append("_ic\" value=\"Y\"")
					.append((ignCase ? " checked=\"checked\"" : ""))
					.append("/>");
			writer.append(ignoreCase);
		} else {
			writer.append("<input type=\"hidden\" name=\"");
			writer.append(modelFormField.getParameterName(context));
			writer.append("_ic\" value=\"").append((ignCase ? "Y" : ""))
					.append("\"/>");
		}
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderRangeFindField(java.io
	 * .Writer, java.util.Map,
	 * org.ofbiz.widget.form.ModelFormField.RangeFindField)
	 */
	public void renderRangeFindField(Appendable writer,
			Map<String, Object> context, RangeFindField rangeFindField)
			throws IOException {
		...
		String value = modelFormField.getEntry(context,
				rangeFindField.getDefaultValue(context));
		if (UtilValidate.isNotEmpty(value)) {
			writer.append(" value=\"");
			writer.append(value);
			writer.append('"');
		...
		writer.append("<option value=\"equals\"")
				.append(("equals".equals(defaultOptionFrom) ? " selected" : ""))
				.append(">").append(opEquals).append("</option>");
		writer.append("<option value=\"greaterThan\"")
				.append(("greaterThan".equals(defaultOptionFrom) ? " selected"
						: "")).append(">").append(opGreaterThan)
				.append("</option>");
		writer.append("<option value=\"greaterThanEqualTo\"")
				.append(("greaterThanEqualTo".equals(defaultOptionFrom) ? " selected"
						: "")).append(">").append(opGreaterThanEquals)
				.append("</option>");
		writer.append("</select>");
		...
		writer.append("<option value=\"lessThan\"")
				.append(("lessThan".equals(defaultOptionThru) ? " selected"
						: "")).append(">").append(opLessThan)
				.append("</option>");
		writer.append("<option value=\"lessThanEqualTo\"")
				.append(("lessThanEqualTo".equals(defaultOptionThru) ? " selected"
						: "")).append(">").append(opLessThanEquals)
				.append("</option>");
		writer.append("</select>");
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderDateFindField(java.io.
	 * Writer, java.util.Map,
	 * org.ofbiz.widget.form.ModelFormField.DateFindField)
	 */
	public void renderDateFindField(Appendable writer,
			Map<String, Object> context, DateFindField dateFindField)
			throws IOException {
		...
		String opGreaterThan = UtilProperties.getMessage("conditional",
				"greater_than", locale);
		String opSameDay = UtilProperties.getMessage("conditional", "same_day",
				locale);
		String opGreaterThanFromDayStart = UtilProperties.getMessage(
				"conditional", "greater_than_from_day_start", locale);
		String opLessThan = UtilProperties.getMessage("conditional",
				"less_than", locale);
		...
		String opUpThruDay = UtilProperties.getMessage("conditional",
				"up_thru_day", locale);
		String opIsEmpty = UtilProperties.getMessage("conditional", "is_empty",
				locale);
		...
		String value = modelFormField.getEntry(context,
				dateFindField.getDefaultValue(context), "_fld0_value");
		if (UtilValidate.isNotEmpty(value)) {
		...
		if (!"time".equals(dateFindField.getType())) {
			...
			writer.append(modelFormField.getModelForm().getCurrentFormName(
					context));
			writer.append('.');
			writer.append(modelFormField.getParameterName(context));
			writer.append("_fld0_value,'");
			writer.append(UtilHttp.encodeBlanks(modelFormField.getEntry(
					context, dateFindField.getDefaultDateTimeString(context))));
			writer.append("');\">");
		...
		String defaultOptionFrom = modelFormField.getEntry(context, null,
				"_fld0_op");
		...
		writer.append("<option value=\"equals\"")
				.append(("equals".equals(defaultOptionFrom) ? " selected" : ""))
				.append(">").append(opEquals).append("</option>");
		writer.append("<option value=\"sameDay\"")
				.append(("sameDay".equals(defaultOptionFrom) ? " selected" : ""))
				.append(">").append(opSameDay).append("</option>");
		writer.append("<option value=\"greaterThanFromDayStart\"")
				.append(("greaterThanFromDayStart".equals(defaultOptionFrom) ? " selected"
						: "")).append(">").append(opGreaterThanFromDayStart)
				.append("</option>");
		writer.append("<option value=\"greaterThan\"")
				.append(("greaterThan".equals(defaultOptionFrom) ? " selected"
						: "")).append(">").append(opGreaterThan)
		...
		value = modelFormField.getEntry(context,
				dateFindField.getDefaultValue(context), "_fld1_value");
		if (UtilValidate.isNotEmpty(value)) {
			if (value.length() > maxlength) {
				value = value.substring(0, maxlength);
			}
		...
		String defaultOptionThru = modelFormField.getEntry(context, null,
				"_fld1_op");
		...
		writer.append("<option value=\"lessThan\"")
				.append(("lessThan".equals(defaultOptionThru) ? " selected"
						: "")).append(">").append(opLessThan)
				.append("</option>");
		writer.append("<option value=\"upToDay\"")
				.append(("upToDay".equals(defaultOptionThru) ? " selected" : ""))
				.append(">").append(opUpToDay).append("</option>");
		writer.append("<option value=\"upThruDay\"")
				.append(("upThruDay".equals(defaultOptionThru) ? " selected"
						: "")).append(">").append(opUpThruDay)
				.append("</option>");
		writer.append("<option value=\"empty\"")
				.append(("empty".equals(defaultOptionThru) ? " selected" : ""))
				.append(">").append(opIsEmpty).append("</option>");
		writer.append("</select>");
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderLookupField(java.io.Writer
	 * , java.util.Map, org.ofbiz.widget.form.ModelFormField.LookupField)
	 */
	public void renderLookupField(Appendable writer,
			Map<String, Object> context, LookupField lookupField)
			throws IOException {
		...
		String value = modelFormField.getEntry(context,
				lookupField.getDefaultValue(context));
		if (UtilValidate.isNotEmpty(value)) {
			writer.append(" value=\"");
			writer.append(value);
			writer.append('"');
	...
	public void renderNextPrev(Appendable writer, Map<String, Object> context,
		...
		if (UtilValidate.isEmpty(targetService) && updateAreas == null) {
			Debug.logWarning(
					"Cannot paginate because TargetService is empty for the form: "
							+ modelForm.getName(), module);
			return;
		}
		...
		if (uiLabelMap == null) {
			...
			Map<String, Integer> messageMap = UtilMisc.toMap("lowCount",
					Integer.valueOf(lowIndex + 1), "highCount",
					Integer.valueOf(lowIndex + actualPageSize), "total",
					Integer.valueOf(listSize));
			commonDisplaying = UtilProperties.getMessage("CommonUiLabels",
					"CommonDisplaying", messageMap,
					(Locale) context.get("locale"));
		}

		// for legacy support, the viewSizeParam is VIEW_SIZE and viewIndexParam
		// is VIEW_INDEX when the fields are "viewSize" and "viewIndex"
		...
		String prepLinkQueryString = UtilHttp
				.getQueryStringFromTarget(targetService);
		...
		prepLinkBuffer.append(viewSizeParam).append("=").append(viewSize)
				.append("&amp;").append(viewIndexParam).append("=");
		...
		writer.append("<div class=\"").append(modelForm.getPaginateStyle())
				.append("\">");
		appendWhitespace(writer);
		writer.append(" <ul>");
		appendWhitespace(writer);
		...
		// First button
		writer.append("  <li class=\"").append(
				modelForm.getPaginateFirstStyle());
		if (viewIndex > 0) {
			writer.append("\"><a href=\"");
			if (ajaxEnabled) {
				writer.append("javascript:ajaxUpdateAreas('")
						.append(createAjaxParamsFromUpdateAreas(updateAreas,
								prepLinkText + 0 + anchor, context))
						.append("')");
			} else {
			...
			writer.append("\">")
					.append(modelForm.getPaginateFirstLabel(context))
					.append("</a>");
		} else {
			// disabled button
			writer.append("-disabled\">").append(
		...
		// Previous button
		writer.append("  <li class=\"").append(
				modelForm.getPaginatePreviousStyle());
		if (viewIndex > 0) {
			writer.append("\"><a href=\"");
			if (ajaxEnabled) {
				writer.append("javascript:ajaxUpdateAreas('")
						.append(createAjaxParamsFromUpdateAreas(updateAreas,
								prepLinkText + (viewIndex - 1) + anchor,
								context)).append("')");
			} else {
			...
			writer.append("\">")
					.append(modelForm.getPaginatePreviousLabel(context))
					.append("</a>");
		} else {
			// disabled button
			writer.append("-disabled\">").append(
		...
		if (listSize > 0 && this.javaScriptEnabled) {
			writer.append("  <li>").append(pageLabel)
					.append(" <select name=\"page\" size=\"1\" onchange=\"");
			if (ajaxEnabled) {
				writer.append("javascript:ajaxUpdateAreas('")
						.append(createAjaxParamsFromUpdateAreas(updateAreas,
		...
		writer.append("  <li class=\"")
				.append(modelForm.getPaginateNextStyle());
		if (highIndex < listSize) {
			...
			writer.append("\">")
					.append(modelForm.getPaginateNextLabel(context))
					.append("</a>");
		} else {
			// disabled button
			writer.append("-disabled\">").append(
		...
		// Last button
		writer.append("  <li class=\"")
				.append(modelForm.getPaginateLastStyle());
		if (highIndex < listSize) {
			writer.append("\"><a href=\"");
			if (ajaxEnabled) {
				writer.append("javascript:ajaxUpdateAreas('")
						.append(createAjaxParamsFromUpdateAreas(updateAreas,
								prepLinkText + (listSize / viewSize) + anchor,
								context)).append("')");
			} else {
			...
			writer.append("\">")
					.append(modelForm.getPaginateLastLabel(context))
					.append("</a>");
		} else {
			// disabled button
			writer.append("-disabled\">").append(
	...
	public void renderSortField(Appendable writer, Map<String, Object> context,
			ModelFormField modelFormField, String titleText) throws IOException {
		boolean ajaxEnabled = false;
		ModelForm modelForm = modelFormField.getModelForm();
		List<ModelForm.UpdateArea> updateAreas = modelForm
				.getOnPaginateUpdateAreas();
		...
		if (UtilValidate.isEmpty(targetService) && updateAreas == null) {
			Debug.logWarning(
					"Cannot sort because TargetService is empty for the form: "
							+ modelForm.getName(), module);
			return;
		}
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderFileField(java.io.Writer,
	 * java.util.Map, org.ofbiz.widget.form.ModelFormField.FileField)
	 */
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderPasswordField(java.io.
	 * Writer, java.util.Map,
	 * org.ofbiz.widget.form.ModelFormField.PasswordField)
	 */
	public void renderPasswordField(Appendable writer,
			Map<String, Object> context, PasswordField passwordField)
			throws IOException {
		...
		String value = modelFormField.getEntry(context,
				passwordField.getDefaultValue(context));
		if (UtilValidate.isNotEmpty(value)) {
			writer.append(" value=\"");
			writer.append(value);
			writer.append('"');
		...
		this.makeHyperlinkString(writer, passwordField.getSubHyperlink(),
				context);
	 ...
	 * 
	 * @see
	 * org.ofbiz.widget.form.FormStringRenderer#renderImageField(java.io.Writer,
	 * java.util.Map, org.ofbiz.widget.form.ModelFormField.ImageField)
	 */
	public void renderImageField(Appendable writer,
			Map<String, Object> context, ImageField imageField)
			throws IOException {
	...
	public void renderFieldGroupOpen(Appendable writer,
			Map<String, Object> context, ModelForm.FieldGroup fieldGroup)
			throws IOException {
		String style = fieldGroup.getStyle();
		String id = fieldGroup.getId();
		FlexibleStringExpander titleNotExpanded = FlexibleStringExpander
				.getInstance(fieldGroup.getTitle());
		...
		if (UtilValidate.isNotEmpty(style) || UtilValidate.isNotEmpty(id)
			...
			if (fieldGroup.collapsible()) {
				...
				Map<String, Object> uiLabelMap = UtilGenerics.checkMap(context
						.get("uiLabelMap"));
				...
				if (collapsed) {
					...
					writer.append(
							...
							.append(collapsibleAreaId).append("', '")
							.append(expandToolTip).append("', '")
							.append(collapseToolTip).append("');\"");
				} else {
			...
			writer.append("<div id=\"").append(collapsibleAreaId)
					.append("\" class=\"fieldgroup-body\"");
	...
	public void renderBanner(Appendable writer, Map<String, Object> context,
			ModelForm.Banner banner) throws IOException {
	 ...
	 * header-link="" specified in the <field > tag, using style from
	 * header-link-style="". Also renders a selectAll checkbox in multi forms.
	 * 
	 * @param writer
	 * @param context
	 ...
	 * @param titleText
	 */
	public void renderHyperlinkTitle(Appendable writer,
			Map<String, Object> context, ModelFormField modelFormField,
			String titleText) throws IOException {
		if (UtilValidate.isNotEmpty(modelFormField.getHeaderLink())) {
			StringBuilder targetBuffer = new StringBuilder();
			FlexibleStringExpander target = FlexibleStringExpander
					.getInstance(modelFormField.getHeaderLink());
			...
			if (UtilValidate.isNotEmpty(targetBuffer.toString())
					&& targetBuffer.toString().toLowerCase()
							.startsWith("javascript:")) {
				targetType = "plain";
			}
			WidgetWorker.makeHyperlinkString(writer,
					modelFormField.getHeaderLinkStyle(), targetType,
					targetBuffer.toString(), null, titleText, null,
					modelFormField, this.request, this.response, null, null);
	 ...
	 * objects. See <code>selectall.js</code>.
	 * 
	 * @param updateAreas
	 * @param extraParams
	 *            Renderer-supplied additional target parameters
	 * @param context
	 * @return Parameter string or empty string if no UpdateArea objects were
	 *         found
	 */
	public String createAjaxParamsFromUpdateAreas(
			List<ModelForm.UpdateArea> updateAreas, String extraParams,
		...
		for (ModelForm.UpdateArea updateArea : updateAreas) {
			...
			try {
				appendOfbizUrl(ajaxUrl,
						UtilHttp.removeQueryStringFromTarget(targetUrl));
			} catch (IOException e) {
