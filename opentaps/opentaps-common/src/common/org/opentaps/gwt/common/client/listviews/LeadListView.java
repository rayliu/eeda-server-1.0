...
public class LeadListView extends PartyListView {
	...
	/**
	 * Default constructor. Set the title to the default lead list title.
	 */
	public LeadListView() {
		super();
	...
	@Override
	public void init() {
		System.out.println("LeadListView init...");
		init(PartyLookupConfiguration.URL_FIND_LEADS, "/crmsfa/control/viewLead?partyId={0}", UtilUi.MSG.crmLeadId(), new String[] {
				...
				// UtilUi.MSG.partyLastName(),
				PartyLookupConfiguration.INOUT_COMPANY_NAME, UtilUi.MSG.crmCompanyName() });
	}

	/**
	 * Filters the records of the list by name of the company matching the given
	 * sub string.
	 * 
	 * @param companyName
	...
	/**
	 * Filters the records of the list by first name of the contact matching the
	 * given sub string.
	 * 
	 * @param firstName
	 *            a <code>String</code> value
	...
	/**
	 * Filters the records of the list by last name of the contact matching the
	 * given sub string.
	 * 
	 * @param lastName
	 *            a <code>String</code> value
